...
public class UserServiceTest extends ModelTestConfig {
	...
	public void searchIdPagingUserTest() {
		...
		pageVo.setKeyword("b");
		/***When***/
		Map<String, Object> map = userService.searchIdPagingUser(pageVo);
	...
	public void searchNamePagingUserTest() {
		...
		pageVo.setKeyword("브");
		/***When***/
		Map<String, Object> map = userService.searchNamePagingUser(pageVo);
	...
	@Test
	public void searchAliasPagingUserTest() {
		/***Given***/
		PageVo pageVo = new PageVo(1, 5);
		pageVo.setKeyword("달");
		/***When***/
		Map<String, Object> map = userService.searchAliasPagingUser(pageVo);
