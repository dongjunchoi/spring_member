...
<!-- Navbar -->
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp}/user/pagingUser" class="nav-link">HOME</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp}/user/pagingUser" class="nav-link">회원관리</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp}/user/logout" class="nav-link">로그아웃</a></li>
			</ul>
